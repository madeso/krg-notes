...
// complex/compound knowledge entry
// here is all the things you can do (not have to!) + all information to do it
...
struct Behavior
{
    ...
    // calculates a score used for behavior selection when we have multiple options
...
// goal: piece of data that defines a "high level thing I can do/use"
